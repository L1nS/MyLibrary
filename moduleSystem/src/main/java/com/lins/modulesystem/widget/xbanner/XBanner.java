package com.lins.modulesystem.widget.xbanner;
...
import com.lins.modulesystem.widget.xbanner.transformers.BasePageTransformer;
import com.lins.modulesystem.widget.xbanner.transformers.Transformer;
...
public class XBanner extends RelativeLayout implements XBannerViewPager.AutoPlayDelegate, ViewPager.OnPageChangeListener {
    ...
    private void initCustomAttrs(Context context, AttributeSet attrs) {
        ...
        if (typedArray != null) {
            ...
            mPointWidth = typedArray.getDimensionPixelSize(R.styleable.XBanner_pointWidth, mPointWidth);
            mPointHeight = typedArray.getDimensionPixelSize(R.styleable.XBanner_pointHeight, mPointHeight);
            ...
            mPointNoraml = typedArray.getResourceId(R.styleable.XBanner_pointNormal, R.drawable.widget_xbanner_shape_point_normal);
            mPointSelected = typedArray.getResourceId(R.styleable.XBanner_pointSelect, R.drawable.widget_xbanner_shape_point_select);
    ...
    public void setData(@NonNull List<?> models, List<String> tips) {
        setData(R.layout.widget_xbanner_item_image, models, tips);
    }
    ...
    public void setBannerData(@NonNull List<? extends SimpleBannerInfo> models) {
        setBannerData(R.layout.widget_xbanner_item_image, models);
    }
    ...
    private void initPoints() {
        if (mPointRealContainerLl != null) {
            ...
            if (getRealCount() > 0 && (mIsShowIndicatorOnlyOne || !mIsOneImg)) {
                LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(mPointWidth, mPointHeight);
