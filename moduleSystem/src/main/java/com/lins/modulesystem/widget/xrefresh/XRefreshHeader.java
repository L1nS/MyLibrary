...
public class XRefreshHeader extends LinearLayout implements BaseRefreshHeader {
    ...
    public XRefreshHeader(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView() {
        LayoutInflater.from(mContext).inflate(R.layout.widget_x_kaws_refresh_header, this);
...
//                    animationDrawable.stop();
//                }
                idPb.setVisibility(GONE);
                msg.setText(R.string.widget_x_listview_header_hint_normal);
                break;
...
//                    }
                    idPb.setVisibility(VISIBLE);
                    msg.setText(R.string.widget_x_listview_header_hint_release);
                }
                break;
            case STATE_REFRESHING:
                msg.setText(R.string.widget_x_refreshing);
                break;
            case STATE_DONE:
                msg.setText(R.string.widget_x_refresh_done);
                break;
            default:
        }
        mState = state;
