package com.lins.modulesystem.widget.loadlayout;
...
public class LoadingLayout extends FrameLayout {
    ...
    public LoadingLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            mNetWorkErrorView = a.getResourceId(R.styleable.LoadingLayout_emptyView, R.layout.widget_loadlayout_network_error);
     ...
     * @param listener
     */
    public void setNetWorkErrorClickListener(OnClickListener listener) {
        if (listener != null) {
            findViewById(R.id.id_rl_network_error).setOnClickListener(listener);
        }
    }
